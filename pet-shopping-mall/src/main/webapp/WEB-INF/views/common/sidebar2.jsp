...
.deleteMember-class {
	...
	display: flex; /* Flex 컨테이너로 설정하여 내부 요소를 가운데로 정렬 */
...
<div id="deleteMember-div" class="deleteMember-class" style="display: none;">
	<div class="deleteMember">
		<span class="deletememberForm-close">×</span>
		<h2>회원 탈퇴</h2>
		<p>정말 탈퇴하시겠습니까??</p>
...
<script>
	const closeDeleteModalBtn = document.getElementById("deleteMemberForm-closeModalBtn");
