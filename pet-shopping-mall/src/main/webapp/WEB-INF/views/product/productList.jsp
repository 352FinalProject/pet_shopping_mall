			...
			<c:forEach items="${productInfos}" var="productInfo" varStatus="vs">
				<div class="product-card">
					...
					<div class="product-desc">
						...
						<span class="review-star"><img src="${pageContext.request.contextPath}/resources/images/상품/star.png" alt="별점" ><span>${productInfo.productReviewStarAvg.reviewStarRate}</span></span>
						<span> &nbsp;|&nbsp; </span>
