...
<section class="common-section" id="#">
	<div class="common-container">
							...
							<c:forEach items="${productDetails}" var="productDetail"
								...
								<c:if test="${not empty productDetail.optionName}">
									<option class="options"
										...
										${productDetail.additionalPrice})</option>
								</c:if>
							</c:forEach>
						</select>
					</div>
		...
		<div class="product-util-div">
			<ul class="product-utility">
				...
				<li><a
					href="${pageContext.request.contextPath}/servicecenter/inquiry/questionCreate.do">1:1문의</a></li>
			</ul>
		</div>
					...
					<ul>
							...
							<div class="star-label-and-progress">
								...
								<div class="progress">
									<div class="progress-bar"
										style="width: ${formattedPercentages[1]}%;"></div>
								</div>
						...
						<li>
							<div class="star-label-and-progress">
								...
								<div class="progress">
									<div class="progress-bar"
										style="width: ${formattedPercentages[2]}%;"></div>
								</div>
						...
						<li>
							<div class="star-label-and-progress">
								...
								<div class="progress">
									<div class="progress-bar"
										style="width: ${formattedPercentages[3]}%;"></div>
								</div>
						...
						<li>
							<div class="star-label-and-progress">
								...
								<div class="progress">
									<div class="progress-bar"
										style="width: ${formattedPercentages[4]}%;"></div>
								</div>
						...
						<li>
							<div class="star-label-and-progress">
								...
								<div class="progress">
									<div class="progress-bar"
										style="width: ${formattedPercentages[5]}%;"></div>
								</div>
					...
					<li>
						<div class="review-box">
							...
							<div class="review-detail-box">
								...
								<em class="review-info-content">${review.reviewContent}</em>
								<!-- 리뷰내용 -->
	...
	<div class="processing-wrap">
		...
		<div class="procedure">
			...
			하자나 오배송 등의 사유로 인한 경우에는 추가적인 안내가 필요할 수 있습니다.<br /> <br />
		</div>
	</div>
	<div class="product-bottom">
		<div class="product-bottom2">
			<div>
				...
				<br /> <span id="product-price"
					style="font-size: 18px; font-weight: 600;"> <fmt:formatNumber
