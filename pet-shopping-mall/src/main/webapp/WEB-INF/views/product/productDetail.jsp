								...
								<c:forEach var="review" items="${reviews}">
									<div class="review-item">
										<div class="review-img">
											...
											<br>
											<div id="imageCarousel_${review.reviewId}"
												...
												<div class="carousel-inner">
													...
													<c:forEach var="filename" items="${imageFilenames}"
														varStatus="loop">
														<c:set var="imagePath"
															value="${pageContext.request.contextPath}/resources/upload/review/${filename}" />
														<div
															class="carousel-item ${loop.index == 0 ? 'active' : ''}">
															<img class="review-img2" alt="Review Image"
																src="${imagePath}">
														</div>
													</c:forEach>
												</div>
												<a class="carousel-control-prev"
													href="#imageCarousel_${review.reviewId}" data-slide="prev">
													<span class="carousel-control-prev-icon"></span>
												</a> <a class="carousel-control-next"
													href="#imageCarousel_${review.reviewId}" data-slide="next">
