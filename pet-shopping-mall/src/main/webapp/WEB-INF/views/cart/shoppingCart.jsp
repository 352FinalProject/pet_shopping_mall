            ...
            <div class="common-div">
            	<div class="shopping-div">
	                ...
	                <div class="cart-right">
						...
						<div>
							<button class="btn btn1" id="order-btn">주문하기</button>
						</div>          
	                </div>
                </div>
            </div>
...
function updateOrderButtonColor() {
	  let isChecked = false;
	  ...
	  if (isChecked) {
	    orderButton.style.backgroundColor = '#5886d3';
	  } else {
	    orderButton.style.backgroundColor = '#c8c8c8'; // Reset to default
	  }
	}

	checkboxes.forEach(checkbox => {
	  checkbox.addEventListener('change', updateOrderButtonColor);
	});
</script>
